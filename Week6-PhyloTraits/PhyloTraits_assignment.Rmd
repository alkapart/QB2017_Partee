...
fit <- lm(log10(BMR_.m102.hour.) ~ log10(Body_mass_for_BMR_.gr.),
          data = pruned.mammal.data)
plot(log10(pruned.mammal.data$Body_mass_for_BMR_.gr.), 
     log10(pruned.mammal.data$BMR_.m102.hour.), las = 1, xlab = 'Body mass (kg), log',
...
fit.phy <- phylolm(log10(BMR_.m102.hour.) ~ log10(Body_mass_for_BMR_.gr.), 
                   data = pruned.mammal.data, pruned.mammal.tree, model = 'lambda',
                   boot = 0)
plot(log10(pruned.mammal.data$Body_mass_for_BMR_.gr.),
     log10(pruned.mammal.data$BMR_.m102.hour.),
